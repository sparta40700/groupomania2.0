    ...
    <div>
      ...
      <div className="container mt-5 mb-5">
        ...
        <form onSubmit={onModifyPostFormSubmit} encType="multipart/form">
          <div className="mb-3">
            <label htmlFor="imagePost" className="form-label">
              Modifiez l'image de cette actualité
            </label>
            <input
              type="file"
              name="image"
          ...
          <div className="mb-3">
            <label htmlFor="title" className="form-label">
              Modifiez le titre de cette l'actualité
            </label>
            <input
              type="text"
              className="form-control"
          ...
          <div className="mb-3">
            <label htmlFor="text" className="form-label">
              Modifiez la description de cette l'actualité
            </label>
            <textarea
              className="form-control"
              id="text"
          ...
          <button type="submit" className="btn btn-primary">
            Enregistrer les modifications sur cette actualité
          </button>
        </form>
      </div>
      <Footer />
